...
let ParsedError, prop, sysPath, _fn, _i, _len, _ref;

sysPath = require('node:path');
...
module.exports = ParsedError = (function() {
  ...
  ParsedError.prototype._parseTraceItem = function(text) {
    let addr, col, d, dir, file, jsCol, jsLine, line, m, original, packageName, packages, path, r, remaining, shortenedAddr, shortenedPath, what;
    text = text.trim();
    if (text === '') {
      return;
    }

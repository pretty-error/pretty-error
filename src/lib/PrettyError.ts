...
const arrayUtils = {
  pluckByCallback: function (a, cb) {
    let index, removed, value, _i, _len;
    if (a.length < 1) {
      return a;
    }
    removed = 0;
  ...
  pluckOneItem: function (a, item) {
    let index, reached, value, _i, _len;
    if (a.length < 1) {
      return a;
    }
    reached = false;
...
const PrettyError = (function () {
  ...
  PrettyError.prototype.getObject = function (e) {
    let count, header, i, item, obj, traceItems, _i, _len, _ref;
  ...
  PrettyError.prototype._skipOrFilter = function (item, itemNumber) {
    ...
    if (typeof item === "object") {
      if (
        ((_ref = item.modName), __indexOf.call(this._packagesToSkip, _ref) >= 0)
      ) {
        return true;
      }
      if (
        ((_ref1 = item.path), __indexOf.call(this._pathsToSkip, _ref1) >= 0)
      ) {
        return true;
      }
      _ref2 = item.packages;

      ...
      },
      {
        ...
        value: function _toDom(input) {
          if (typeof input === "string") {
            ...
            throw Error(
              "Invalid input type. Only strings, arrays and objects are accepted",
            );
          }
        },
      },
      ...
      },
      {
        ...
        value: function _isBlock(node) {
          return !(
            node.type === "text" ||
            node.name === "br" ||
            this._getStyleFor(node).display !== "block"
          );
        },
      },
      {
        ...
        value: function _isNone(node) {
          return !(
            node.type === "text" ||
            node.name === "br" ||
            this._getStyleFor(node).display !== "none"
          );
        },
      },
    ]);
